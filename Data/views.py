...
def index(request):
    ...
    if request.method == 'POST':
        ...
        df = yf.download(st_name, start='2018-01-01', end=end_date)
        ...
        quote = yf.download(st_name, start='2019-01-01', end=end_date)
        ...
        api_request = requests.get(
            "https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=" + search + ".BSE&apikey=BP39EYKNTFWF2FOF")
        try:
            print(api_request)
